            ...
            <div className="flex flex-col items-center relative">
              <div className="flex flex-col items-center relative">
                <div className="relative">
                  ...
                  />
                  <div className="flex h-10 px-4 py-2 flex-col items-center absolute left-1/2 -translate-x-1/2 bottom-14 rounded-full bg-white/90 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.1)]">
