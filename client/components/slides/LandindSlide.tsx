...
const LandindSlide: React.FC<LandindSlideProps> = ({
  slideObject,
  onButtonClick,
}) => {
          ...
          {branding.headerBlocks.map((block, index) => (
            ...
            >
              <div className="flex pr-2 flex-col items-start relative">
                <div
                  className={`${index === 0 ? "text-studevo-indigo" : "text-studevo-emerald"} font-['Material_Icons'] text-2xl font-normal leading-6 relative`}
                >
        ...
        <div className="flex flex-col items-start gap-2 w-full relative">
          ...
          <div className="h-8 w-full relative">
            <div className="flex w-[322px] h-4 flex-col justify-center flex-shrink-0 text-studevo-gray text-center font-poppins text-xs font-normal leading-4 absolute left-3 top-0">
              ...
              <a
                href={branding.footerLinks[0]?.href || "#"}
            ...
            <div className="w-[260px] h-8 flex-shrink-0 absolute left-[117px] top-[-1px]">
              <a
                href={branding.footerLinks[1]?.href || "#"}
                className="flex w-11 h-4 flex-col justify-center flex-shrink-0 text-studevo-gray text-center font-poppins text-xs font-normal leading-4 underline absolute left-[217px] top-[1px]"
              >
                Privacy
              </a>
              <a
                href={branding.footerLinks[1]?.href || "#"}
                className="flex w-[35px] h-4 flex-col justify-center flex-shrink-0 text-studevo-gray text-center font-poppins text-xs font-normal leading-4 underline absolute left-0 top-[17px]"
              >
                Policy
              </a>
            </div>
            <div className="flex w-[121px] h-4 flex-col justify-center flex-shrink-0 text-studevo-gray text-center font-poppins text-xs font-normal leading-4 absolute left-[152px] top-4">
              <span>, </span>
              <a
                href={branding.footerLinks[2]?.href || "#"}
                className="underline inline"
              >
                Subscription Terms
              </a>
